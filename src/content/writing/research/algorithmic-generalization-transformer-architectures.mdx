...
date: "2025-10-20"
updated: "2026-05-24"
summary: "Four architectural mechanisms to improve OOD algorithmic generalization in Transformers, evaluated on a modular-arithmetic circuit task."
venue: "Under review"
...
<style>{`
  ...
  .method-results-figure {
    display: grid;
    grid-template-rows: minmax(0, 1fr) auto;
    gap: 10px;
  }

  .method-results-figure .article-figure__body {
    min-height: 0;
    width: 100%;
  }

  .method-results-figure .article-picture {
    aspect-ratio: 1.55 / 1;
    height: auto;
    max-height: none;
    object-fit: contain;
  ...
  .method-results-figure figcaption {
    margin-top: 0;
  }
...
<Figure class="dag-example-figure">
  <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/formula_graph.pdf" alt="Computation Graph" invertInDarkMode />
...
<FigureGrid columns={4} caption="Four architectural mechanisms enabling algorithmic generalization. (1) Recurrence allows adaptive computation depth matching problem complexity; (2) Algorithmic Supervision guides learning toward the correct layer-by-layer algorithm via latent space supervision; (3) Discretization creates stable checkpoints preventing representational drift across iterations; (4) Error Correction enables the model to detect and fix its own mistakes during iterative reasoning.">
  <Figure caption="Recurrence & Adaptive Computation">
    <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/mech1.SVG" alt="Recurrence & Adaptive Computation" invertInDarkMode />
  </Figure>
  <Figure caption="Algorithmic Supervision">
    <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/mech2.SVG" alt="Algorithmic Supervision" invertInDarkMode />
  </Figure>
  <Figure caption="Anchored Discrete Latent Space">
    <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/mech3.SVG" alt="Anchored Discrete Latent Space" invertInDarkMode />
  </Figure>
  <Figure caption="Error Correction">
    <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/mech4.SVG" alt="Error Correction" invertInDarkMode />
  </Figure>
</FigureGrid>
...
<TwoColumns>
  ...
  >
    <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/method_ood_comparison_legendtop.pdf" alt="Method OOD Comparison" invertInDarkMode />
  </Figure>
  <Figure
    slot="right"
    class="method-results-figure"
  ...
  >
    <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/ourmethod_stepwise_results_Blues.pdf" alt="Stepwise Results" invertInDarkMode />
  </Figure>
</TwoColumns>
...
<Callout type="question" title="Central Questions">
...
<Figure caption="The complete computational circuit showing how each layer contributes.">
  <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/2-layer-illustrated.pdf" alt="Complete Mechanism" invertInDarkMode />
</Figure>
...
<Figure caption="First-layer attention heads organize into groups based on which variable position they track. This figure shows the grouping structure discovered through relative variance analysis.">
  <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/L0_head_allocation.pdf" alt="L0 Head Allocation" invertInDarkMode />
</Figure>
...
<FigureGrid columns={4}>
  <Figure caption="`var₀` (Heads 4, 8)">
    <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/L0_var_0_relative_variance_heatmap.pdf" alt="VAR_0" invertInDarkMode />
  </Figure>
  <Figure caption="`var₁` (Heads 5, 12)">
    <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/L0_var_1_relative_variance_heatmap.pdf" alt="VAR_1" invertInDarkMode />
  </Figure>
  <Figure caption="`var₂` (Heads 3, 7, 11, 14)">
    <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/L0_var_2_relative_variance_heatmap.pdf" alt="VAR_2" invertInDarkMode />
  </Figure>
  <Figure caption="`rhs` (result position)">
    <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/L0_rhs_relative_variance_heatmap.pdf" alt="RHS" invertInDarkMode />
  </Figure>
</FigureGrid>
...
<Figure caption="Operator norm amplification for different factored embedding types across all 16 attention heads.">
  <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/L0_ov_operator_norm_mpl.pdf" alt="L0 OV Norm" invertInDarkMode />
</Figure>
...
<Figure caption="Layer 1 MLP contributes minimally; most work happens in attention and the final MLP.">
  <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/l2_relative_error.pdf" alt="L2 Relative Error" invertInDarkMode />
</Figure>
...
<FigureGrid columns={3}>
  <Figure caption="`var₀` relative variance">
    <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/l1_attention_head_statistics_var0.pdf" alt="VAR_0_stats" invertInDarkMode />
  </Figure>
  <Figure caption="`var₁` relative variance">
    <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/l1_attention_head_statistics_var1.pdf" alt="VAR_1_stats" invertInDarkMode />
  </Figure>
  <Figure caption="`var₂` relative variance">
    <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/l1_attention_head_statistics_var2.pdf" alt="VAR_2_stats" invertInDarkMode />
  </Figure>
</FigureGrid>
...
<Figure caption="Operator norm amplification for Layer 2 heads.">
  <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/L1_ov_operator_norm.pdf" alt="L1 OV Operator Norm" invertInDarkMode />
</Figure>
...
<Figure caption="Before MLP: Dominated by bias term (0,0,0 frequency)">
  <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/fft_histograms_L1-mlp-preact.pdf" alt="FFT MLP Preact" invertInDarkMode />
</Figure>

<Figure caption="During MLP: Bias decreases, diagonal frequencies increase.">
  <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/fft_histograms_L1-mlp-postact.pdf" alt="FFT MLP Postact" invertInDarkMode />
</Figure>

<Figure>
  <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/fft_histograms_L1-mlp-output.pdf" alt="FFT MLP Output" invertInDarkMode />
...
<Figure caption="Final output maintains the frequency structure for decoding.">
  <Picture slot="figure" src="/writing/research/algorithmic-generalization-transformer-architectures/figures/fft_histograms_decoder-output.pdf" alt="FFT Decoder Output" invertInDarkMode />
</Figure>
