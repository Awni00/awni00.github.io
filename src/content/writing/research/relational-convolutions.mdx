...
external:
  ...
  publisher_page: "https://openreview.net/forum?id=vNZlnznmV2"
bibtex: |
...
<WrapFigure
  src="/writing/research/relational-convolutions/figs/relconv_architecture.png"
  alt="Relational Convolutional Networks architecture diagram"
  caption="Figure: A depiction of the compositional architecture of relational convolutional networks."
>
...
<PlotlyFigure src="/writing/research/relational-convolutions/figs/relational_games_ood_gen.html" iframeTitle="Relational games out-of-distribution generalization" height="520px" width="100%" showOpenLink={false} />
...
<PlotlyFigure src="/writing/research/relational-convolutions/figs/contains_set_acc.html" iframeTitle="SET accuracy" height="520px" width="100%" showOpenLink={false} />
...
<PlotlyFigure src="/writing/research/relational-convolutions/figs/contains_set_conv_rep.html" iframeTitle="SET convolution representation" height="520px" width="100%" showOpenLink={false} />
