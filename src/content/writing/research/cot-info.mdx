...
<Figure>
  <ImageComparison slot="figure" client:idle
    leftLabel="Instant"
    rightLabel="Thinking"
    showLabels={false}
  >
    <Picture slot="itemOne" src="/writing/research/cot-info/figs/gpt_cot_examples/number-comparison-gpt5-instant+.png" alt="ChatGPT 5 Instant answers the number comparison question incorrectly when forced to respond immediately." invertInDarkMode />
    <Picture slot="itemTwo" src="/writing/research/cot-info/figs/gpt_cot_examples/number-comparison-gpt5-thinking+.png" alt="ChatGPT 5 Thinking solves the number comparison question correctly by reasoning step-by-step." invertInDarkMode />
  </ImageComparison>
...
<Figure>
  <ImageComparison slot="figure" client:idle
    ...
    showLabels={false}
  >
    <Picture slot="itemOne" src="/writing/research/cot-info/figs/gpt_cot_examples/forest-no-cot.png" alt="ChatGPT 5 Instant fails on the forestry word problem without reasoning." invertInDarkMode />
    <Picture slot="itemTwo" src="/writing/research/cot-info/figs/gpt_cot_examples/forest-cot-gpt5-thinking.png" alt="ChatGPT 5 Thinking solves the forestry word problem with chain-of-thought supervision." invertInDarkMode />
  </ImageComparison>
  <Fragment slot="caption">
    ChatGPT 5 Instant (left), prompted to respond instantly, guesses the wrong answer. ChatGPT Thinking (right) produces the correct answer after reasoning step-by-step.
  </Fragment>
...
<Figure>
  <ImageComparison slot="figure" client:idle
    ...
    showLabels={false}
  >
    <Picture slot="itemOne" src="/writing/research/cot-info/figs/gpt_cot_examples/syseq-gpt5-instant.png" alt="ChatGPT 5 Instant fails to solve the linear system without reasoning." invertInDarkMode />
    <Picture slot="itemTwo" src="/writing/research/cot-info/figs/gpt_cot_examples/syseq-gpt5-thinking.png" alt="ChatGPT 5 Thinking solves the linear system with a reasoning trace." invertInDarkMode />
  </ImageComparison>
  <Fragment slot="caption">
    ChatGPT 5 Instant (left), prompted to respond instantly, guesses the wrong answer. ChatGPT Thinking (right) produces the correct answer after reasoning step-by-step.
  </Fragment>
...
<TwoColumns>
  <Figure slot="left">
    <Picture slot="figure" src="/writing/research/cot-info/figs/simulation_figs/DFA_transition_diagram.pdf" alt="Deterministic finite automaton with four states used in the simulation." invertInDarkMode />
