...
venue: "Neural Information Processing Systems (NeurIPS), spotlight"
...
external:
  ...
  publisher_page: "https://neurips.cc/virtual/2025/loc/san-diego/poster/118270"
...
<Figure>
  <ToggleFigure slot="figure" ariaLabel="ChatGPT 5 response variants" defaultValue="instant">
    <ToggleFigurePanel label="ChatGPT 5 Instant" value="instant">
      <Picture src="/writing/research/cot-info/figs/gpt_cot_examples/number-comparison-gpt5-instant+.png" alt="ChatGPT 5 Instant answers the number comparison question incorrectly when forced to respond immediately." invertInDarkMode />
    </ToggleFigurePanel>
    <ToggleFigurePanel label="ChatGPT 5 Thinking" value="thinking">
      <Picture src="/writing/research/cot-info/figs/gpt_cot_examples/number-comparison-gpt5-thinking+.png" alt="ChatGPT 5 Thinking solves the number comparison question correctly by reasoning step-by-step." invertInDarkMode />
    </ToggleFigurePanel>
  </ToggleFigure>
  <Fragment slot="caption">
    ChatGPT 5 Instant, prompted to respond instantly, guesses the wrong answer. ChatGPT 5 Thinking produces the correct answer after reasoning step-by-step.
  </Fragment>
</Figure>
...
<Figure>
  <ToggleFigure slot="figure" ariaLabel="ChatGPT 5 response variants" defaultValue="instant">
    <ToggleFigurePanel label="ChatGPT 5 Instant" value="instant">
      <Picture src="/writing/research/cot-info/figs/gpt_cot_examples/forest-no-cot.png" alt="ChatGPT 5 Instant fails on the forestry word problem without reasoning." invertInDarkMode />
    </ToggleFigurePanel>
    <ToggleFigurePanel label="ChatGPT 5 Thinking" value="thinking">
      <Picture src="/writing/research/cot-info/figs/gpt_cot_examples/forest-cot-gpt5-thinking.png" alt="ChatGPT 5 Thinking solves the forestry word problem with chain-of-thought supervision." invertInDarkMode />
    </ToggleFigurePanel>
  </ToggleFigure>
  <Fragment slot="caption">
    ChatGPT 5 Instant, prompted to respond instantly, guesses the wrong answer. ChatGPT 5 Thinking produces the correct answer after reasoning step-by-step.
...
<Figure>
  <ToggleFigure slot="figure" ariaLabel="ChatGPT 5 response variants" defaultValue="instant">
    <ToggleFigurePanel label="ChatGPT 5 Instant" value="instant">
      <Picture src="/writing/research/cot-info/figs/gpt_cot_examples/syseq-gpt5-instant.png" alt="ChatGPT 5 Instant fails to solve the linear system without reasoning." invertInDarkMode />
    </ToggleFigurePanel>
    <ToggleFigurePanel label="ChatGPT 5 Thinking" value="thinking">
      <Picture src="/writing/research/cot-info/figs/gpt_cot_examples/syseq-gpt5-thinking.png" alt="ChatGPT 5 Thinking solves the linear system with a reasoning trace." invertInDarkMode />
    </ToggleFigurePanel>
  </ToggleFigure>
  <Fragment slot="caption">
    ChatGPT 5 Instant, prompted to respond instantly, guesses the wrong answer. ChatGPT 5 Thinking produces the correct answer after reasoning step-by-step.
...
[^humancot]: [Cobbe et al. (GSM8K)](https://arxiv.org/abs/2110.14168)
[^modelcot]: [Wang et al. (self-consistency)](https://arxiv.org/abs/2203.11171); [Zelikman et al. (STaR)](https://arxiv.org/abs/2203.14465); [Lightman et al. (Let's Verify Step by Step)](https://arxiv.org/abs/2305.20050).
...
[^joshietal]: [Joshi et al. (2025) [arXiv:2505.15927]](https://arxiv.org/abs/2505.15927)
...
<Statement label="Definition" title="CoT Information">
...
<Figure>
  <Picture slot="figure" src="/writing/research/cot-info/figs/diagrams/cotcons_dynamic_diagram.pdf" alt="Multi-panel illustration comparing end-to-end and CoT consistency sets as sample size increases." />
  <Fragment slot="caption">Geometry of CoT information: consistency sets shrink much faster under CoT supervision.</Fragment>
</Figure>

<Statement label="Result" title="Sample Complexity Under CoT Supervision" accent="#ef4444">
...
<Statement label="Result" title="Lower Bound via Two-Point Method" accent="#ef4444">
...
<Statement label="Result" title="Lower Bound via Fano's Method" accent="#ef4444">
...
<FigureGrid columns={2} equalFrames mediaAspectRatio="3 / 2">
  <Figure>
    <Picture slot="figure" src="/writing/research/cot-info/figs/simulation_figs/LinearThresh_Wind8A2L8/20250505-191322/figs/CoTInfo_vs_E2EDiff.pdf" alt="Scatter plot comparing CoT information and end-to-end disagreement for the linear autoregressive class." invertInDarkMode />
  ...
  <Figure>
    <Picture slot="figure" src="/writing/research/cot-info/figs/simulation_figs/LinearThresh_Wind8A2L8/20250505-191322/figs/CoTInfo_vs_Epsilon_log.pdf" alt="Plot of CoT information as a function of epsilon for the linear autoregressive class." invertInDarkMode />
  ...
  <Figure>
    <Picture slot="figure" src="/writing/research/cot-info/figs/simulation_figs/LinearThresh_Wind8A2L8/20250505-191322/figs/empirical_sample_complexity_legendin.pdf" alt="Empirical sample complexity for end-to-end vs CoT consistency in the linear autoregressive class." invertInDarkMode />
    <Fragment slot="caption">Empirical sample complexity for end-to-end versus CoT learning.</Fragment>
  </Figure>
  <Figure>
    <Picture slot="figure" src="/writing/research/cot-info/figs/simulation_figs/LinearThresh_Wind8A2L8/20250505-191322/figs/learning_curves_prob_success_eps0_log_legendin_e2eerr.pdf" alt="Empirical probability of zero error for end-to-end vs CoT learners in the linear autoregressive class." invertInDarkMode />
...
<FigureGrid columns={2} mediaFit="contain" equalFrames mediaAspectRatio="3 / 2">
  <Figure>
    <Picture
      slot="figure"
      src="/writing/research/cot-info/figs/simulation_figs/DFA_transition_diagram.pdf"
      alt="Deterministic finite automaton with four states used in the simulation."
      invertInDarkMode
    />
    <Fragment slot="caption">DFA whose state trajectory forms the chain-of-thought trace.</Fragment>
  </Figure>
  <Figure>
    <Picture slot="figure" src="/writing/research/cot-info/figs/simulation_figs/DFA_S4A2L10_varycotdetail/20250503-194523/figs/CoTInfoRatio_vs_Epsilon_by_detail_log.pdf" alt="CoT information ratio as a function of epsilon under varying detail levels of the DFA trace." invertInDarkMode />
    <Fragment slot="caption">How CoT information scales with epsilon as trace detail varies.</Fragment>
  </Figure>
  <Figure>
    <Picture slot="figure" src="/writing/research/cot-info/figs/simulation_figs/DFA_S4A2L10_learning/20250504-165732/figs/empirical_sample_complexity_legendin.pdf" alt="Empirical sample complexity for DFA learning under end-to-end vs CoT supervision." invertInDarkMode />
    <Fragment slot="caption">Empirical sample complexity for end-to-end versus CoT learning.</Fragment>
  </Figure>
  <Figure>
    <Picture slot="figure" src="/writing/research/cot-info/figs/simulation_figs/DFA_S4A2L10_learning/20250504-165732/figs/learning_curves_prob_success_eps0_log_legendin.pdf" alt="Probability of zero error for DFA learning with and without CoT supervision." invertInDarkMode />
    <Fragment slot="caption">Probability that each learning rule achieves zero error as the sample size grows.</Fragment>
  </Figure>
</FigureGrid>
