...
**Where to start:** If you're interested in neural network architectures, start with [Dual Attention Transformers](/writing/research/dual-attention), an extension of the Transformer architecture with explicit relational mechanisms and inductive biases. For theoretical analysis of modern machine learning methods, see [CoT Information](/writing/research/cot-info), our statistical learning theory framework for chain-of-thought supervised learning.
